	...
	<form id="id_form"> 
		<div class="row" style="margin-top: 5%">
			<div class="form-group col-sm-6">
				...
				<div class="col-sm-8">
					<input class="form-control" type="text" id="id_nombre" name="nombre" placeholder="Ingrese el nombre" maxlength="100">
				</div>
			</div>
			<div class="form-group  col-sm-6">
				<div class="col-sm-4">
				...
				<div class="col-sm-6">
					<input class="form-control" type="text" id="id_alias" name="alias" placeholder="Ingrese el alias" maxlength="100">
		 		</div>
			</div>
		</div>
		...
		<div class="row" style="margin-top: 0%">
			<div class="form-group  col-sm-6">
				...
				<div class="col-sm-6">
					<input class="form-control" type="number" id="id_experiencia" name="experiencia" placeholder="Ingrese la experiencia">
		 		</div>
			</div>
		</div>
			...
			nombre: {
				...
				validators: {
					...
					stringLength: {
						min: 3,
						max: 90,
						message: 'El nombre es de 3 a 90 caracteres'
					},
				}
			},
			alias: {
				...
				validators: {
					...
					stringLength: {
						min: 3,
						max: 90,
						message: 'El alias es de 3 a 90 caracteres'
					},
				}
			},
			pais: {
				...
				validators: {
					...
					stringLength: {
						min: 3,
						max: 80,
						message: 'El país es de 3 a 80 caracteres'
					},
				}
			},
			juego: {
				...
				validators: {
					...
					stringLength: {
						min: 3,
						max: 100,
						message: 'El juego es de 3 a 100 caracteres'
					},
				}
			},
			experiencia: {
