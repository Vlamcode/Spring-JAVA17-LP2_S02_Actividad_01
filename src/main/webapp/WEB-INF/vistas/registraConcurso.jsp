	...
	<form id="id_form"> 
		...
		<div class="row" style="margin-top: 0%">
			<div class="form-group col-sm-6">
				...
				<div class="col-sm-8">
					<input class="form-control" type="date" id="id_fechaFin" name="fechaFin" placeholder="Ingrese la fecha de fin">
				</div>
			</div>
			<div class="form-group  col-sm-6">
				<div class="col-sm-4">
				...
				<div class="col-sm-6">
					<input class="form-control" type="text" id="id_estado" name="estado" placeholder="Ingrese el estado" maxlength="45">
		 		</div>
			</div>
		</div>
